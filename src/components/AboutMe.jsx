            ...
            <div className="aboutMe d-flex flex-md-row flex-column justify-content-around col-12 my-4">
                ...
                <div className="d-flex flex-column flex-wrap col-md-8 col-12 align-items-start container">
                    <p>
                        ...
                        elit. Tempore natus qui pariatur dolores nihil
                        dignissimos quos illo suscipit at id nesciunt, eos,
                        nobis asperiores sapiente recusandae architecto, rerum
                        eius iusto.
                    </p>
                    <p>
                        Lorem, ipsum dolor sit amet consectetur adipisicing
                    ...
                    <a className="btn btn-outline-dark mt-3" download>
